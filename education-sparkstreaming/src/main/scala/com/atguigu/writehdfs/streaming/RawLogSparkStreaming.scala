package com.atguigu.writehdfs.streaming
...
object RawLogSparkStreaming {
  ...
  private val hdfsBasicPath = "hdfs://HA/user/atguigu/rawlogdata/"
...
//      .setMaster("local[*]")
    ...
    sparkContext.hadoopConfiguration.set("fs.defaultFS", "hdfs://HA")
    sparkContext.hadoopConfiguration.set("dfs.nameservices", "HA")
