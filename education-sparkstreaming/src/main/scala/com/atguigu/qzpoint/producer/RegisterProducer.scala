...
//    ssc.textFile(this.getClass.getResource("D:\\MyWork\\education-online\\logs\\register.log").getPath, 10)
    ssc.textFile("D:\\MyWork\\education-online\\logs\\register.log", 10)
